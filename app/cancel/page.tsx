...
export default async function PaymentCancelled({ searchParams }: { searchParams: { session_id?: string } }) {
    ...
    <div className="min-h-screen bg-gradient-to-br from-red-50 to-orange-100 flex items-center justify-center p-4">
      <div className="max-w-2xl w-full bg-white rounded-2xl shadow-2xl overflow-hidden">
        ...
        <div className="bg-gradient-to-r from-red-500 to-orange-600 p-8 text-center">
          ...
          <p className="text-red-50 text-lg">Your transaction was not completed</p>
        </div>
        ...
        <div className="p-8">
          <div className="mb-6 pb-6 border-b border-gray-200">
            ...
            <div className="grid grid-cols-2 gap-4 text-sm">
              ...
              <div className="col-span-2">
                ...
                <p className="font-semibold text-gray-800 text-lg">{orderDetails.amount}</p>
              </div>
            </div>
          ...
          {/* Items List */}
          <div className="mb-6">
            <h3 className="text-lg font-semibold text-gray-800 mb-3">Items in Cart</h3>
            <div className="space-y-2">
              {orderDetails.items.map((item, index) => (
                <div key={index} className="flex justify-between items-center p-3 bg-gray-50 rounded-lg opacity-75">
                  <div>
          ...
          <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 mb-6">
            <div className="flex gap-3">
              ...
              <div>
                <p className="text-sm text-amber-900 font-medium mb-1">What happened?</p>
                <p className="text-sm text-amber-800">
                  Your payment was cancelled and no charges were made to your account. Your items are still saved in your cart.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gray-50 rounded-lg p-4 mb-6">
            <p className="text-sm font-semibold text-gray-800 mb-2">Common reasons for cancellation:</p>
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-600">
              Need help? <button className="text-blue-600 hover:text-blue-700 font-semibold underline">Contact Support</button>
            </p>
          </div>
        </div>
      </div>
